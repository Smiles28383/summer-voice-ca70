...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/summer-voice-ca70)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/summer-voice-ca70
```

A live public deployment of this template is available at [https://summer-voice-ca70.templates.workers.dev](https://summer-voice-ca70.templates.workers.dev)
